...
# 1. Custom environment variables defined below after kubengine defaults
# 2. Constants defined in this file (environment variables with no default), i.e. KUBENGINE_ROOT_DIR
...
export KUBENGINE_ROOT_DIR="/opt/kubengine"
export KUBENGINE_VOLUME_DIR="/kubengine"

# Logging configuration
export MODULE="${MODULE:-redis}"
export KUBENGINE_DEBUG="${KUBENGINE_DEBUG:-false}"
...
# Paths
export REDIS_VOLUME_DIR="${KUBENGINE_VOLUME_DIR}/redis"
export REDIS_BASE_DIR="${KUBENGINE_ROOT_DIR}/redis"
...
export PATH="${REDIS_BIN_DIR}:${KUBENGINE_ROOT_DIR}/common/bin:${PATH}"
