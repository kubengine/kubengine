...
# Paths
export REDIS_SENTINEL_VOLUME_DIR="/kubengine/redis-sentinel"
export REDIS_SENTINEL_BASE_DIR="${KUBENGINE_ROOT_DIR}/redis-sentinel"
...
export PATH="${REDIS_SENTINEL_BIN_DIR}:${KUBENGINE_ROOT_DIR}/common/bin:${PATH}"
