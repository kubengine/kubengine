...
class Builder(BaseBuilder):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        logger.info(f"Kylin 构建器初始化完成: {name}")
    ...
    def _custom_step(self, context: BuildContext) -> None:
        ...
        context.log_operation("开始 Kylin 自定义构建步骤")
        ...
        try:
            ...
            context.log_operation("Kylin 自定义构建步骤完成")
    ...
    def _configure_network(self, context: BuildContext, config: ConfigDict) -> None:
        ...
        # 配置hosts文件
        hostname = config.get("hostname", "kylin")

        hosts_content = f"""# Generated by Kylin Builder
